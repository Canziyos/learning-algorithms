...
from utils import batch_backward, MSE, win_num
import optim
from flatten import Flatten  # <- our new atheist friend
...
out_len = win_num(len(train[0][0]), conv.padding, conv.filter_s, conv.stride)
...
for epoch in range(epochs):
    grads, loss = batch_backward(net, train, MSE)
